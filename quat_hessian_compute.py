...
The purpose of this file is to automate generating the quaternion expressions
before converting to C++ as part of the 4x4 block of the Q cost matrix
corresponding to the quaternion over time.  This matrix is almost always not
PSD, so regularization is required.

The C++ implementation is located in dairlib as
systems/controllers/quaternion_error_hessian.cc
"""
